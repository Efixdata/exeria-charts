...
const CRYPTO_SYMBOLS = [
  ...
  { id: "ETH-USDT", name: "Ethereum (ETH)" },
  { id: "SOL-USDT", name: "Solana (SOL)" },
  { id: "ADA-USDT", name: "Cardano (ADA)" },
  { id: "XRP-USDT", name: "Ripple (XRP)" },
];
...
export default function KucoinConnectorExample() {
      ...
      {priceData && (
        <div className={styles.priceDisplay}>
          ...
          <div className={styles.info}>
            <p>
              <strong>✓ Real-time Data:</strong> Historical OHLC from KuCoin REST API
            </p>
            <p>
              <strong>✓ WebSocket:</strong> Live candle updates via Classic `/market/candles`
            </p>
            <p>
              <strong>✓ USDT pairs:</strong> Uses KuCoin symbols like <code>BTC-USDT</code>
            </p>
          </div>
...
const adapter = new KucoinAdapter({ pageDelayMs: 300 });
