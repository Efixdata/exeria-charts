...
export default function OkxConnectorExample() {
  ...
  useEffect(() => {
    ...
    const initChart = async () => {
      ...
      try {
        ...
        adapterRef.current = new OkxAdapter();
      ...
      {priceData && (
        <div className={styles.priceDisplay}>
          ...
          <div className={styles.info}>
            <p>
              <strong>✓ Real-time Data:</strong> Data fetched live from OKX REST API v5
            </p>
            <p>
              <strong>✓ No API Key Required:</strong> Using OKX public spot endpoints
            </p>
            <p>
