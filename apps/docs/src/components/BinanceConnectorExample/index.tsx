...
export default function BinanceConnectorExample() {
  ...
  useEffect(() => {
    ...
    const initChart = async () => {
      ...
      try {
        ...
        // Create Binance connector and pass into chart options so the
        // chart can use connector-provided historical and realtime data.
  ...
  useEffect(() => {
    ...
    const loadData = async () => {
      ...
      try {
        // Use chart's `loadData` which will use the provided connector
        // (connector handles historical fetches and websocket updates).
        if (chartRef.current) {
          try {
            ...
            // Try to get current price from connector
