...
const ASSET_GROUPS: AssetGroup[] = [
  {
    ...
    label: "Forex",
    symbols: [
      { id: "EUR/USD", name: "Euro / US Dollar", buttonLabel: "EURUSD", priceDecimals: 5 },
      { id: "GBP/USD", name: "British Pound / US Dollar", buttonLabel: "GBPUSD", priceDecimals: 5 },
      { id: "USD/JPY", name: "US Dollar / Japanese Yen", buttonLabel: "USDJPY", priceDecimals: 3 },
      { id: "USD/CHF", name: "US Dollar / Swiss Franc", buttonLabel: "USDCHF", priceDecimals: 5 },
      { id: "AUD/USD", name: "Australian Dollar / US Dollar", buttonLabel: "AUDUSD", priceDecimals: 5 },
      { id: "EUR/GBP", name: "Euro / British Pound", buttonLabel: "EURGBP", priceDecimals: 5 },
    ],
  },
  {
    id: "stocks",
  ...
  },
  {
    ...
    label: "Crypto",
    symbols: [
      { id: "BTC/USD", name: "Bitcoin / US Dollar", buttonLabel: "BTCUSD", priceDecimals: 2 },
    ],
  },
];
...
function findSymbolMeta(symbolId: string): DemoSymbol {
  return (
    ALL_SYMBOLS.find((symbol) => symbol.id === symbolId) ?? {
      id: symbolId,
      name: symbolId,
      buttonLabel: symbolId.replace("/", ""),
      priceDecimals: 4,
    }
  );
}

export default function TwelveDataConnectorExample() {
  ...
  const adapterRef = useRef<ProxyTwelveDataAdapter | null>(null);
  ...
  useEffect(() => {
    ...
    const initChart = async () => {
      ...
      try {
        ...
        adapterRef.current = new ProxyTwelveDataAdapter();
      ...
      {priceData && (
        <div className={styles.priceDisplay}>
          ...
          <div className={styles.info}>
            <p>
              <strong>✓ Twelve Data proxy:</strong> Forex, stocks, ETFs, and crypto via
              `/api/twelve-data`
            </p>
            <p>
              <strong>✓ Demo key:</strong> Public demo supports a limited symbol set (e.g. AAPL,
              QQQ, BTC/USD). Some tickers require your own API key.
            </p>
            <p>
