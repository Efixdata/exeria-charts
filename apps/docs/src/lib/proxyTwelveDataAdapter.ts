...
export type ProxyTwelveDataAdapterConfig = {
  apiBase?: string;
...
export class ProxyTwelveDataAdapter implements DataAdapter {
  ...
  constructor(config: ProxyTwelveDataAdapterConfig = {}) {
    this.apiBase = config.apiBase ?? "/api/twelve-data";
