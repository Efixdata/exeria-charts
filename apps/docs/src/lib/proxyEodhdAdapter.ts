...
export type ProxyEodhdAdapterConfig = {
  apiBase?: string;
...
export class ProxyEodhdAdapter implements DataAdapter {
  ...
  constructor(config: ProxyEodhdAdapterConfig = {}) {
    this.apiBase = config.apiBase ?? "/api/eodhd";
