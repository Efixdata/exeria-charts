...
export type ProxyCcxtAdapterConfig = {
  exchangeId: string;
  apiBase?: string;
...
export class ProxyCcxtAdapter implements DataAdapter {
  ...
  constructor(config: ProxyCcxtAdapterConfig) {
    this.exchangeId = config.exchangeId;
    this.apiBase = config.apiBase ?? "/api/ccxt";
