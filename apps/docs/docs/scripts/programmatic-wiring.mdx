...
The first `chart.addScript("EMA")` case is straightforward because the script definition already carries usable defaults. The next level is wiring one script to the outputs of another.
