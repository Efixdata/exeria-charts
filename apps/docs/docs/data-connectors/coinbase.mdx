...
sidebar_position: 7
title: Coinbase
description: Coinbase adapter (@efix-data/adapter-coinbase) — live and historical crypto charts from Advanced Trade, no API key required.
---
...
```bash
npm install @exeria/charts @efix-data/adapter-coinbase
```
