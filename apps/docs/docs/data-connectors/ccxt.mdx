...
If you only ship Binance, Coinbase, or Gate.io in the browser, use [@efix-data/adapter-binance](./binance), [@efix-data/adapter-coinbase](./coinbase), or [@efix-data/adapter-gate](./gate). If you need Kraken tomorrow and KuCoin next week on your server, use CCXT.

## Install

```bash
npm install @exeria/charts @efix-data/adapter-ccxt
```
