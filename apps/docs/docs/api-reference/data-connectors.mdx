...
import { intervalFromSymbol, milisFromIntervalSymbol } from "@exeria/charts";
```
...
| Package | Doc |
| --- | --- |
| `@efix-data/adapter-binance` | [Binance](../data-connectors/binance) · [live demo](/binance-example) |
| `@efix-data/adapter-bybit` | [Bybit](../data-connectors/bybit) · [live demo](/bybit-example) |
| `@efix-data/adapter-okx` | [OKX](../data-connectors/okx) · [live demo](/okx-example) |
| `@efix-data/adapter-kraken` | [Kraken](../data-connectors/kraken) · [live demo](/kraken-example) |
| `@efix-data/adapter-kucoin` | [KuCoin](../data-connectors/kucoin) · [live demo](/kucoin-example) |
| `@efix-data/adapter-coinbase` | [Coinbase](../data-connectors/coinbase) · [live demo](/coinbase-example) |
| `@efix-data/adapter-gate` | [Gate.io](../data-connectors/gate) · [live demo](/gate-example) |
| `@efix-data/adapter-ccxt` | [CCXT (multi-exchange)](../data-connectors/ccxt) · [live demo](/ccxt-example) |
| `@efix-data/adapter-twelve-data` | [Twelve Data](../data-connectors/twelve-data) · [live demo](/twelve-data-example) |
| `@efix-data/adapter-finage` | [Finage](../data-connectors/finage) · [live demo](/finage-example) |
| `@efix-data/adapter-finnhub` | [Finnhub](../data-connectors/finnhub) · [live demo](/finnhub-example) |
| `@efix-data/adapter-eodhd` | [EODHD](../data-connectors/eodhd) · [live demo](/eodhd-example) |
| `@efix-data/adapter-massive` | [Massive](../data-connectors/massive) · [live demo](/massive-example) |
| `@efix-data/adapter-coingecko` | [CoinGecko](../data-connectors/coingecko) · [live demo](/coingecko-example) |
...
| Type not found | Import from `@exeria/charts`, not from adapter |
