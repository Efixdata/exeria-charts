...
export default function createDECISIONLONGSELLIndicatorScript(FUSION: CoreFusionStatic) {
  return {
      ...
      var Controller: FusionScriptControllerConstructor = function (
        ...
        this.calculate = function (this: any, index: any) {
          ...
          if (index > this.PROGNOSIS_PERIODS + this.PERIODS) {
            ...
            if (this.CLOSE.getValue(index) !== null && this.CLOSE.getValue(index) > values.upper) {
              signal = FUSION.SELL;
            }
          }
