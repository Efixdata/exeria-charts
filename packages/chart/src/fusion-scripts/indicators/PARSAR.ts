  ...
  return defineScript({
    ...
    controller: createController(function (this: FusionScriptControllerRuntime) {
        ...
        this.calculate = function (this: any, index: any) {
          ...
          if (
            this.PARSAR.getValue(index - 1) === null ||
            this.EXTREMESERIES.getValue(index - 1) === null ||
            this.AFSERIES.getValue(index - 1) === null
          ) {
            this.af = this.MAF;
            this.issLong = true;
            ...
            if (this.ISLONG.getValue(index - 1) == 1) this.issLong = true;
            else this.issLong = false;
          }
          ...
          if (index > 0) {
            if (this.issLong) this.ISLONG.setValue(index, 1);
            else this.ISLONG.setValue(index, 0);
            this.AFSERIES.setValue(index, this.af);
            this.EXTREMESERIES.setValue(index, this.extreme);
          }
