...
export default function createINFORMATIONRATIOIndicatorScript(FUSION: CoreFusionStatic) {
  return {
    ...
    plotters: [
      {
        type: "SeriesObject",
        dataLink: "INFORMATIONRATIO",
        renderAs: "Line",
        dataField: "INFORMATIONRATIO",
        color: "#ff9800",
        width: 1.5,
        dash: [],
        priceTag: true,
    ...
    controller: function (
      ...
      var Controller: FusionScriptControllerConstructor = function (
        ...
        this.init = function (this: any) {
          ...
          this.BENCHMARKRATEOFRETURN = this.context.getRawSeriesWrapper(
            this.helper,
            "BENCHMARKRATEOFRETURN"
          );
          this.BENCHMARKRATEOFRETURNSUM = this.context.getRawSeriesWrapper(
            this.helper,
            "BENCHMARKRATEOFRETURNSUM"
          );
        ...
        this.calculate = function (this: any, index: any) {
          ...
          const benchmarkRateOfReturnSum = FUSION.lib.getSum(
            this.BENCHMARKRATEOFRETURN,
            index,
            this.PERIODS,
            this.BENCHMARKRATEOFRETURNSUM
          );
          ...
          const informationRatio =
            (averageRateOfReturn - benchmarkAverageRateOfReturn) / trackingError;
