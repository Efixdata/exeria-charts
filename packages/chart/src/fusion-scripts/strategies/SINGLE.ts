...
export default function createSINGLEStrategyScript(FUSION: CoreFusionStatic) {
  return {
    ...
    controller: function (
      ...
      var SINGLEcontroller: FusionScriptControllerConstructor = function (
        ...
        this.calculate = function (this: any, INDEX: any) {
          ...
          } else this.calculateWithoutRealMarketPositions(INDEX);
        };
        ...
        this.calculateWithoutRealMarketPositions = function (this: any, INDEX: any) {
          ...
          if (this.lastSignal == signal) {
            ...
            if (this.TYPE == "simple") {
              ...
              if (signalStr > 0) this.CORRECTION = signalStr;
