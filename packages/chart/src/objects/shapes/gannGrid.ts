...
function GannGridObject(this: ShapeRuntime) {
  ...
  this.hit = function (...[x, y, o, renderer, interactor, model, panel, seriesManager]: ShapeHitArgs) {
    ...
    if (!hitGannSegments(x, y, collectGannSquareHitSegments(geometry), this.hitTolerance)) {
      return false;
    }
...
const GannGridObjectCtor: import("./_sharedTypes").ShapeConstructor =
  GannGridObject as unknown as import("./_sharedTypes").ShapeConstructor;
export { GannGridObjectCtor as GannGridObject };
