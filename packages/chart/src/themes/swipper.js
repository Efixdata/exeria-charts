...
export const chartTheme = {
  colors: {
    ...
    defaultToolColor: { dark: blue }, // like trendline etc.
    ...
    overlay: { dark: red }, // not used in chart

    // labels at the top of the chart
    legendLabelColor: { dark: 'rgba(255,255,255,0.7)' }, // Default text color
    legendValueColor: { dark: white }, // Used only if the indicator has no color
    legendLineBackground: { dark: 'rgba(10, 39, 56, 0.7)' }, // background of the line
