const locale: Record<string, unknown> = {
  ...
  newsFeedDescription: "External news events imported as chart markers",
  newsFeedSentiment: "Sentiment",
  newsFeedPositiveColor: "Positive",
  newsFeedNegativeColor: "Negative",
  ...
  chart_settings_overlay_symbol_hint: "Chart type, line, fill, gradient and candle colors",
  ...
  chart_settings_legend: "Legend",
  chart_settings_legend_hint: "Top-left panel labels (symbol, O/H/L/C, indicators)",
  chart_settings_legend_main_instrument: "Main symbol",
  chart_settings_legend_main_instrument_hint: "Legend for the primary instrument in the main pane",
  chart_settings_legend_overlay_instruments: "Overlay symbols",
  chart_settings_legend_overlay_instruments_hint: "Legends for additional symbols on the chart",
  chart_settings_legend_indicators: "Indicators",
  chart_settings_legend_indicators_hint: "Legends for indicators and scripts in chart panes",
  ...
  preset_carbon_description: "Enterprise trading terminal",
  preset_onyx_label: "Monochrome",
  preset_onyx_description: "Pure black and white light theme",
  preset_day_label: "Day",
  preset_day_description: "Default light theme",
  preset_paper_label: "Pearl",
  preset_paper_description: "Warm neutral light theme",
  ...
  toolbar_indicators: "Indicators",
  chart_settings_confirm: "OK",
  drawing_settings_pnl_summary: "P&L summary",
  drawing_settings_pnl_value: "Value",
  toolbar_group_chart_type_interval: "Chart type and interval",
  toolbar_group_scale: "Scale",
  toolbar_group_chart_actions: "Chart actions",
};
