const locale = {
    ...
    "not_available_packages": "Some of the objects or indicators are unavailable. Please subscribe following packages to display full content of the chart",
    ...
    "exceedInfo1": "Signal occure when series C is above series A (single signal possible after choosing the option)",
    "exceedInfo2": "or when series D is below series B (single signal possible after choosing the option).",
    ...
    "reboundInfo1": "Signals when series C comes back from above to the range between upper band (series A) and lower band (series B).",
    "reboundInfo2": "Signals when series C comes back from below to the range between upper band (series A) and lower band (series B).",
    ...
    "greaterLessInfo1": "Signals when series A is above series B (single signal possible after choosing the option).",
    "greaterLessInfo2": "Signals when series A is below series B (single signal possible after choosing the option).",
    ...
    "singleSignalsInfo2": "If Reverse option is selected then position size will be equal to 1 after buy signal and -1 after sell signal.",
    ...
    "joinInfo": "Combination between X and Y strategy signals. Click \"Table button\" to see which signals are generated depending on strategy X and Y signals.",
    ...
    "selectiveSignalsInfo": "Combination of signals from strategy X and strategy Y as defined by the User in the table. click \"Table button\" to indicate which signal is generated depending on signals from strategies X and Y.",

    "positionSizeTitle": "Position size",
    "positionSizeInfo": "Indicator displays position size of chosen strategy (X). Position size can be multiplied by the Multiplier and Weight. The Multiplier can be any series (e.g. rate of exchange) and/or constant (e.g. 2).",
    "weight": "Weight",
    "multiplier": "Multiplier",

    "buySellSizeTitle": "Buy Sell Size",
    "buySellSizeInfo": "Transform Position Size into strategy which contains only Buy and Sell signals with proper strength (size). You can also transform chosen strategy (X) then calculations are performed on strategies position size.",
    ...
    "instrument_not_tradable": "Instrument not tradable. <br/><br/>To create an order, make sure, you added broker account and selected the instrument supported by connected broker",
    ...
    "layouts_sn_description": "Recommendations, news, interesting facts. Follow your friends and experts.",
    "layouts_front_title": "Trading Platform",
    "layouts_front_description": "Trade from any device with multiple brokers using algorythmic trading and cloud computing.",
    "layouts_title": "Start exploring Exeria with predefined layouts",
    "layouts_mobile_title": "Trading Platform",
    "layouts_mobile_description": "Trade with many brokers, view and analyse charts, read recommendations and run automated strategies in one place.",

    "pages_open": "Open",
    "pages_strategies_url": "https://about.exeria.com/en/strategies.html",
    "pages_strategies_title": "Automatic Strategies",
    "pages_strategies_description": "Browse and use ready-made algorithms to control the markets and execute trades.",
    ...
    "pages_blog_description": "Read analysis created by experts and learn to trade in financial markets.",
